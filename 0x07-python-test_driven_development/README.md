...
- ***Files*** - 5-text_indentation.py, tests/5-text_indentation.txt, 5-main.py
...
- ***Task*** - In this task, you will write unittests for the function def max_integer(list=[]):.
...
- ***Files*** - tests/6-max_integer_test.py, 6-main.py, 6-max_integer.py
...
- ***Task*** - Write a function that multiplies 2 matrices:
...
- ***TASK*** - Write a function that multiplies 2 matrices by using the module NumPy
